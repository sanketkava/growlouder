...
const Footer = () => {
  // ✅ Active social links only (baaki pachhi add kari saks)
  const socialLinks = [
    { 
      icon: Linkedin, 
      href: 'https://in.linkedin.com/company/growlouder?trk=public_post_feed-actor-name', 
      label: 'LinkedIn', 
      color: 'hover:bg-blue-700' 
    },
    { 
      icon: Instagram, 
      href: 'https://www.instagram.com/growlouder.in/', 
      label: 'Instagram', 
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          ...
          <p className="text-gray-500">
            © {new Date().getFullYear()} GROWLOUDER. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

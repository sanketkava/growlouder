...
const Footer = () => {
  const socialLinks = [
    ...
    { icon: Instagram, href: 'https://www.instagram.com/growlouder.in/', label: 'Instagram', color: 'hover:bg-pink-600' },
    { icon: Linkedin, href: 'https://in.linkedin.com/company/growlouder', label: 'LinkedIn', color: 'hover:bg-blue-700' },
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-center md:justify-start text-gray-400">
                ...
                <span>admin@growlouder.in</span>
              </div>
              <div className="flex items-center justify-center md:justify-start text-gray-400">
                <Phone size={16} className="mr-3 text-[var(--gold)]" />
                <span>+91 9016758329</span>
              </div>
              <div className="flex items-center justify-center md:justify-start text-gray-400">
